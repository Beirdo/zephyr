...
{
#ifdef CONFIG_SOC_ATMEL_SAMD1X_XOSC
...
{
#ifdef CONFIG_SOC_ATMEL_SAMD1X_XOSC32K
...
#if defined(CONFIG_SOC_ATMEL_SAMD1X_XOSC32K_AS_MAIN)
	/* Route XOSC32K to GCLK1 */
	GCLK->GENCTRL.reg =
	    GCLK_GENCTRL_ID(1) | GCLK_GENCTRL_SRC_XOSC32K | GCLK_GENCTRL_GENEN;
#elif defined(CONFIG_SOC_ATMEL_SAMD1X_OSC8M_AS_MAIN)
